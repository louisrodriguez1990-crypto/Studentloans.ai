...
//   - The SAVE Plan is subject to a court injunction (8th Circuit, 2024).
//   - Borrowers enrolled in SAVE are in administrative forbearance.
//   - New enrollments are blocked pending litigation outcome.
//   - Update POLICY_CONFIG.save in lib/policy-config.ts when litigation resolves.
...
export function checkSAVEEligibility(
  ...
  const affectedByInjunction = POLICY_CONFIG.save.injunctionActive;
